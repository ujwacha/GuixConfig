...
|----------------+----------------------------------------------|
| Config Part    | Description                                  |
|----------------+----------------------------------------------|
| System Config  | This part will contain all of the            |
|                | stuff related to my system config            |
|                | including the most inportant packaes         |
|                | for my entire system                         |
|----------------+----------------------------------------------|
| Home Config    | This part will contain all of the home       |
|                | configurations, including the fun guile      |
|                | codes I write.                               |
|----------------+----------------------------------------------|
| Channel Config | This part will define all the channels I use |
|                | Fore example the nonguix channel             |
|----------------+----------------------------------------------|
